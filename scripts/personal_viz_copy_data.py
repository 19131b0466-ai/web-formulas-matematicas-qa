...
COPY_ES: dict[str, tuple[str, str]] = {
    ...
    'ALG-EQU-001': (
        ...
        'Mueve la pendiente y el intercepto y busca dónde la recta cruza el eje horizontal.',
    ),
    'ALG-EQU-003': (
    ...
    'ALG-INE-001': (
        ...
        'Cambia el borde y el tipo de desigualdad: la zona sombreada es tu solución.',
    ),
    'ALG-INE-002': (
...
COPY_I18N: dict[str, dict[str, tuple[str, str]]] = {
    'en': {
        ...
        'Move the slope and intercept and look for where the line crosses the horizontal axis.',
    ),
        'ALG-EQU-003': (
        ...
        'Change the boundary and the inequality type: the shaded region is your solution.',
    ),
        'ALG-INE-002': (
        ...
        'Try swapping, scaling, or adding rows and watch how \\(A\\) changes.',
    ),
        'ALG-SIS-005': (
    ...
    'de': {
        ...
        'Probiere Tauschen, Skalieren oder Addieren von Zeilen und schau, wie \\(A\\) sich ändert.',
    ),
        'ALG-SIS-005': (
    ...
    'fr': {
        ...
        'Essaie d’échanger, d’échelonner ou d’ajouter des lignes et regarde comment \\(A\\) change.',
    ),
        'ALG-SIS-005': (
    ...
    'pt': {
        ...
        'Experimenta trocar, escalar ou somar linhas e olha como muda \\(A\\).',
    ),
        'ALG-SIS-005': (
